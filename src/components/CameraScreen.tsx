...
export default function CameraScreen() {
    ...
    const getCamera = async () => {
        const cam = await videoHandler(canvasRef).then();
        setCamera(cam);
    };
                ...
                <div className="flex flex-row w-full  justify-center items-center">
                    <div className="mt-8 w-5/6 code-example">
                        ...
                        <div className="code-preview-wrapper">
                            ...
                            <div
                                id="default-footer-example"
                                className="flex p-0 bg-white border-gray-200 bg-gradient-to-r code-preview dark:bg-gray-900 border-x dark:border-gray-600">
                                <div className="w-full code-responsive-wrapper">
                                    <div
                                        className="flex items-center justify-center w-full p-5 bg-white dark:bg-gray-900 hidden"
